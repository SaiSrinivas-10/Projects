...
<nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="introduction">
        <div class="row" >
            ...
            <div class="col-md-6">
                <a href="viewinventory.php"><button class="btn1" type="button" >View Inventory</button><a>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                <a href="updateinventory.php"><button class="btn1" type="button">Update inventory</button></a>
            </div>
        </div>
    </div>
