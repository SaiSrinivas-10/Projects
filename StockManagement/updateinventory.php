...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">Redirect to <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li role="presentation"><a href="viewinventory.php">View Inventory</a></li>
    ...
    <div class="introduction">
        <h1 style="color:purple;">Update Stock</h1>
        <p>Update Items quantity here</p><br>
        <form method="POST">
            <div class="inputs">
                ...
                <input type="number" name ="stock" placeholder="Update Stock" required autocomplete="off" ><br><br>
